package com.java.practice.ratelimit.constant;
...
public final class XHeader {
    ...
    public static final String API_KEY_DASH = "Api-Key-";
    public static final String IP_DASH = "Ip-";

    private XHeader() {
        throw new RuntimeException("Constructor can't initialized");
    }
}
